    ...
    <div class="outer">
        <div class="middle">
            <div class="inner">
                <h1>Analizy:</h1>
                <div class="second">
                    <div class="opakowaniezdjec">
                        <div onclick="window.open('https://www.youtube.com/watch?v=WWMY_EGhfTA', '_blank')" class="kwadrat1"></div>
                        <div onclick="window.open('https://www.youtube.com/watch?v=CyhDIg-ozFo', '_blank')" class="kwadrat2"></div>
                        <div onclick="window.open('https://www.youtube.com/watch?v=-iqL2Ald3SU', '_blank')" class="kwadrat3"></div>
                        <div onclick="window.open('https://www.youtube.com/watch?v=yWPL4Ap-jZc', '_blank')" class="kwadrat4"></div>
                    </div>
                </div>
            </div>
        </div>
